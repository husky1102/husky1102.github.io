...
test("primary pages expose non-empty description and Open Graph description metadata", () => {
  ...
  for (const page of primaryPages) {
    ...
    assert.match(html, /<meta property="og:image" content="https:\/\/husky1102\.github\.io\/images\/character-welcome-1024\.webp">/);
...
test("homepage motion assets load only on the homepage", () => {
  ...
  assert.match(home, /assets\/js\/site\.min\.js[\s\S]*assets\/js\/home-motion\.min\.js/);
